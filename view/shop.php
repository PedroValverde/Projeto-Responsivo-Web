...
<section ng-controller="destaque-controller">
    <div class="container" id="destaque-produto-container" >
    ...
    <div id="mais-buscados" class="container">
        ...
        <div class="row text-center tittle-defaut-roxo">
        ...
        <div class="row">
            <div class="col-md-3" ng-repeat="produto in buscados">
                <div class="box-produto-info">
                    ...
                    <div class="text-valor text-roxo">{{produto.total}}</div>
...
angular.module("shop", []).controller("destaque-controller", function($scope, $http){
    ...
    var initCarousel = function(){
        $("#destaque-produto").owlCarousel({
            autoPlay: 5000,
            items: 1,
            singleItem: true
        });

        var owlDestaque = $("#destaque-produto").data('owlCarousel');
    ...
    }, function errorCallcak(response){
